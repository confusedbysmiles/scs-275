SCS 275: Written Homework: US Cybersecurity Policy
================================================

[Go up to the SCS 275 HW page](index.html) ([md](index.md))

You will want to see the
[homeworks policies page](../SHU/hw-policies.html)
([md](../SHU/hw-policies.md)) for formatting and other details.  The
due dates are listed on the [SHU course page](../SHU/index.html)
([md](../SHU/index.md)).
...
give you a zero!*** The [HW policies page](../SHU/hw-policies.html)
([md](../SHU/hw-policies.md)) discusses this in a bit more detail.
...
[homeworks policies page](../SHU/hw-policies.html)
([md](../SHU/hw-policies.md))?  When one is grading dozens of these
...
3. Is your essay it 500 words or less?  If not, you are going to get a
   zero!
4. You ***MUST*** name your file userid.pdf where 'userid' is your SHU userid.
