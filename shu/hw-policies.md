SCS 275: Homeworks: Homework Submission Policies
============================================

[Go up to the SCS 275 SHU page](index.html) ([md](index.md))
...
Submission is through the [online submission system](https://www.gradescope.com/courses/1205567).  Note that the assignment will not open up until a few days before the due date.
...
work, and you are bound by SHU's honor policy.
...
your source).  See [the syllabus](../SHU/syllabus.html)
([md](../SHU/syllabus.md)) for more details.
...
assignment that is 1 second late to 24 hours late will lose its score
...
still has to be reasonably good English grammar (and spelling).
...
While this is not an English course, you have to have well-written English in
your document -- both spelling and grammar.  If you can't figure out
what that squiggly red line under a misspelled word means, then we are
...
level elective for computer science majors, so if you don't submit it
